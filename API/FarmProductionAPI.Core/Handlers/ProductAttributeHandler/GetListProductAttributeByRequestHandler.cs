...
{
    public class GetListProductAttributeByRequestHandler : IRequestHandler<GetListProductAttributeByRequestQuery, ResponseResultAPI<List<ProductAttributeDTO>>>
    {
        ...
        public GetListProductAttributeByRequestHandler(IMapper mapper, ILogger logger, IRepository<ProductAttribute> repository, IUnitOfWork unitOfWork)
        {
            _mapper = mapper;
            _logger = logger;
        ...
        public async Task<ResponseResultAPI<List<ProductAttributeDTO>>> Handle(GetListProductAttributeByRequestQuery request, CancellationToken cancellationToken)
        {
            try
            {
                var atts = _repository.GetAll().AsQueryable();
